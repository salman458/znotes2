    ...
    renderBody() {
        return (
            <div className="something">
                <p style={{color: "white"}} className="sv"><b>Management </b> <label style={{position: "relative", top: "10px"}}> <Switch
                    onChange={this.handleChange} checked={this.state.checked}/></label> Contributors</p>
