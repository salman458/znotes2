        ...
        <div className={classes.root}>
            <GridList className={classes.gridList} cols={2.5}>
                <GridListTile key="someKey">
                    <p>I've always been that kind of student who despised theory parts of a subject and loved 'to
                        ...
                        upcoming exams or even a simple school test. ZNotes are highly reliable! </p>
\                    <GridListTileBar
                        title="Adeen Atif"
                        classes={{
                ...
                <GridListTile key="someKe1">
                    <p>Thank you very much to the people who made such notes. May God increase your knowledge and
                        keep showering His blessings on you guys. Lots of love. </p>
                    <GridListTileBar
                ...
                <GridListTile key="someKe1">
                    <p>I hope to see A2 notes for Computer Science soon and can’t wait for this site to be more
                ...
                <GridListTile key="someKe1">
                    <p>I found myself in a time of darkness, completely lost and devastated from my upcoming exams
                        ...
                        ZNotes and my heart is at peace. Thank you for being a legend. </p>
                    <GridListTileBar
                        title="Christine"
                        classes={{
                            root: classes.titleBar,
                ...
                <GridListTile key="someKe1">
                    <p>Asalam Alaikom brother. Thank you so much for sharing these notes with others. I’m very
                        grateful for your help. Wish there’ll be more good people like. Stay safe! </p>
                    <GridListTileBar
                        title="Anonymous"
                        classes={{
                            root: classes.titleBar,
                ...
                <GridListTile key="someKe1">
                    <p>yo yo yo guys.... One would truly and genuinely appreciate thine notes being thrust onto the
                ...
                <GridListTile key="someKe1">
                    <p>These notes are absolutely amazing and have motivated me towards getting A*s in my A level.
                        Your guidelines are also very helpful. Lots of prayers for you.  </p>
                    <GridListTileBar
                        title="Anonymous"
                        classes={{
                            root: classes.titleBar,
                ...
                <GridListTile key="someKe1">
                    <p>I owe a lot to ZNotes. My friends and I would often pore over our textbooks in hopes of
                        ...
                        where I'm pursuing a degree in Mechanical Engineering in the USA.” </p>
                    <GridListTileBar
                        title="Vivek Golla"
                        classes={{
                            root: classes.titleBar,
                ...
                <GridListTile key="someKe1">
                    <p>Hi! I've been using ZNotes for the past 2 years now and wish that I could discover it before!
                        ...
                        Zubair, who has wholeheartedly dedicated his time to really sculpt this learning hub. </p>
                    <GridListTileBar
                        title="Adnan Khan"
                        classes={{
                            root: classes.titleBar,
