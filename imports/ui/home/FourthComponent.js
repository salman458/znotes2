                ...
                <Slider>
                    <Slide index={1}>
                        <div className="testimonialsContainer">
                            <p><b>I've always been that kind of student who despised theory parts of a subject and loved 'to
                                ...
                                upcoming exams or even a simple school test. ZNotes are highly reliable!</b></p>
                            <br/>
                            <br/>
                            <p><b>Adeen Atif</b></p>
                        </div>
                    ...
                    <Slide index={2}>
                        <div className="testimonialsContainer">
                            <p><b>Thank you very much to the people who made such notes. May God increase your knowledge and keep showering His blessings
                                on you guys. Lots of love.</b></p>
                            <br/>
                            <br/>
                    ...
                    <Slide index={3}>
                        <div className="testimonialsContainer">
                            <p><b> hope to see A2 notes for Computer Science soon and can’t wait for this site to be more
                    ...
                    <Slide index={4}>
                        <div className="testimonialsContainer">
                            <p><b> I found myself in a time of darkness, completely lost and devastated from my upcoming exams
                                ...
                                ZNotes and my heart is at peace. Thank you for being a legend.</b></p>
                            <br/>
                            <br/>
                            <p><b>Christine</b></p>
                        </div>
                    ...
                    <Slide index={5}>
                        <div className="testimonialsContainer">
                            <p><b>Asalam Alaikom brother. Thank you so much for sharing these notes with others. I’m very
                                grateful for your help. Wish there’ll be more good people like. Stay safe!</b></p>
                            <br/>
                            <br/>
                            <p><b>Anonymous</b></p>
                        </div>
                    ...
                    <Slide index={6}>
                        <div className="testimonialsContainer">
                            <p><b>yo yo yo guys.... One would truly and genuinely appreciate thine notes being thrust onto the
                    ...
                    <Slide index={7}>
                        <div className="testimonialsContainer">
                            <p><b>These notes are absolutely amazing and have motivated me towards getting A*s in my A level.
                                Your guidelines are also very helpful. Lots of prayers for you. </b></p>
                            <br/>
                            <br/>
                            <p><b>Anonymous</b></p>
                        </div>
                    ...
                    <Slide index={8}>
                        <div className="testimonialsContainer">
                            <p><b>I owe a lot to ZNotes. My friends and I would often pore over our textbooks in hopes of
                                ...
                                where I'm pursuing a degree in Mechanical Engineering in the USA.” </b></p>
                            <br/>
                            <br/>
                            <p><b>Vivek Golla</b></p>
                        </div>
                    ...
                    <Slide index={9}>
                        <div className="testimonialsContainer">
                            <p><b>Hi! I've been using ZNotes for the past 2 years now and wish that I could discover it before!
                                ...
                                Zubair, who has wholeheartedly dedicated his time to really sculpt this learning hub. </b></p>
                            <br/>
                            <br/>
                            <p><b>Adnan Khan</b></p>
                        </div>
