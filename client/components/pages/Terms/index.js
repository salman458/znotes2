...
const Terms = () =>
  <PageContainer className="page_privacy-container">
    <p align="center">
    ...
    <p>
      ...
      and conditions), and ZNotes Education Limited, the owner and operator of
      this Website and ZNotes Foundation. Please read these terms and conditions
      carefully, as they affect your legal rights. Your agreement to comply with
      and be bound by these terms and conditions is deemed to occur upon your
      first use of the Website. If you do not agree to be bound by these terms
      and conditions, you should stop using the Website immediately.
    </p>
    <p>
      In these terms and conditions, <strong>User</strong> or{" "}
      <strong>Users</strong> means any third party that accesses the Website and
      is not either (i) employed by ZNotes Education Limited or ZNotes
      Foundation and acting in the course of their employment or (ii) engaged as
      a consultant or otherwise providing services to ZNotes Education Limited
      or ZNotes Foundation and accessing the Website in connection with the
      provision of such services.
    </p>
    <p>
      You must be at least 13 years of age to use this Website. By using the
      Website and agreeing to these terms and conditions, you represent and
      warrant that you are at least 13 years of age or have the consent of a
      parent or other appropriate adult.
    </p>
    <br />
    <p>
    ...
    <p>
      ...
      property of ZNotes Education Limited, ZNotes Foundation, our affiliates or
      ...
      information capable of being stored in a computer that appears on or forms
      part of this Website, including any such content uploaded by Users. By
      continuing to use the Website you acknowledge that such Content is
      protected by copyright, trademarks, database rights and other intellectual
    ...
    <p>b. print one copy of the Content</p>
    <p>
      3. You must not otherwise reproduce, modify, copy, distribute or use for
      commercial purposes any Content without the written permission of ZNotes
      Education Limited or ZNotes Foundation.
    </p>
    <p>
      4. You acknowledge that you are responsible for any Content you may submit
      via the Website, including the legality, reliability, appropriateness,
      originality and copyright of any such Content. You may not upload to,
      distribute or otherwise publish through the Website any Content that (i)
      ...
      any content. You may not upload commercial content onto the Website.
    </p>
    <p>
      ...
      indemnify ZNotes Education Limited and/or ZNotes Foundation for all claims
    ...
    <p>
      7. You must ensure that the details provided by you on registration or at
      any time are correct and complete.
    </p>
    <p>
      8. You must inform us immediately of any changes to the information that
      you provide when registering by updating your personal details to ensure
      we can communicate with you effectively.
    </p>
    <p>
      9. We may suspend or cancel your registration with immediate effect for
      any reasonable purposes or if you breach these terms and conditions.
    </p>
    <p>
      10. You may cancel your registration at any time by informing us in
      writing to the address at the end of these terms and conditions. If you do
      so, you must immediately stop using the Website. Cancellation or
    ...
    <p>
      11. When you register on this Website, you will be asked to create a
    ...
    <p>
      ...
      misuse of the Website or breach of security, we may require you to change
    ...
    <p>
      13. This Website may contain links to other sites. Unless expressly
      stated, these sites are not under the control of ZNotes Education Limited,
      ZNotes Foundation or that of our affiliates.
    </p>
    <p>
    ...
    <p>
      15. The inclusion of a link to another site on this Website does not imply
    ...
    <p>
      16. Use of the Website is also governed by our Privacy and Cookies Policy,
      which are incorporated into these terms and conditions by this reference.
      To view the Privacy and Cookies Policy, please click on the following:
      www.znotes.org/privacy
    </p>
    <br />
    <p>
    ...
    <p>
      17. Any online facilities, tools, services or information that ZNotes
      Education Limited and/or ZNotes Foundation makes available through the
      Website (the <strong>Service</strong>) is provided "as is" and on an "as
      ...
      ZNotes Education Limited and ZNotes Foundation are under no obligation to
      update information on the Website.
    </p>
    <p>
      18. Whilst ZNotes Education Limited and ZNotes Foundation use reasonable
      endeavours to ensure that the Website is secure and free of errors,
      viruses and other malware, we give no warranty or guaranty in that regard
      and all Users take responsibility for their own security, that of their
      personal details and their computers.
    </p>
    <p>
      19. ZNotes Education Limited and ZNotes Foundation accept no liability for
      any disruption or non-availability of the Website.
    </p>
    <p>
      20. ZNotes Education Limited and ZNotes Foundation reserve the right to
      ...
      These terms and conditions shall continue to apply to any modified version
    ...
    <p>
      22. To the extent that the Website and Content are provided free of
      charge, we will not be liable to you for any loss or damage of any kind.
    </p>
    <p>
      23. We will not be liable to you in respect of any losses arising out of
      events beyond our reasonable control.
    </p>
    <p>
      24. To the maximum extent permitted by law, ZNotes Education Limited and
      ZNotes Foundation accept no liability for any of the following:
    </p>
    <p>
    ...
    <p>
      27. These terms and conditions together with the Privacy and Cookies
    ...
    <br />
    <p>
      <h2> ZNotes Education Limited and ZNotes Foundation details</h2>
    </p>
    <p>
      32. ZNotes Education Limited is a company incorporated in England and
      Wales with registration number 12520980 whose registered address is Office
      14 Cedar House, 58 Peregrine Road, Ilford, Essex, IG6 3SZ, and it operates
      the website www.znotes.org. You can contact ZNotes Education Limited by
      email on info@znotes.org.
    </p>
    <p>
      33. ZNotes Foundation is a company incorporated in England and Wales with
      registration number 12525460 whose registered address is Office 14 Cedar
      House, 58 Peregrine Road, Ilford, Essex, IG6 3SZ.
    </p>
  </PageContainer>;
