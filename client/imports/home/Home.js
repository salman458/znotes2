...
class Home extends AbstractComponent {
    getSuggestions = (value) => {
      ...
      return inputLength === 0 ? [] : this.state.keywords.filter((lang) => lang.name.toLowerCase().slice(0, inputLength) === inputValue);
    };
            ...
            >
              <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g id="homepage-dark" transform="translate(-1824.000000, -683.000000)" fill="#383838">
                  <g id="Group-10" transform="translate(1820.000000, 514.000000)">
                    <circle id="Oval" cx="16" cy="181" r="12" />
                  </g>
                </g>
              </g>
            </svg>
          ...
          <ul className="social">
            ...
            <li>
              <a href="https://www.facebook.com/" target="_blank">
                ...
                >
                  <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="team-dark" transform="translate(-759.000000, -2361.000000)" fill="#FFFFFF" fillRule="nonzero">
            ...
            <li>
              <a href="https://www.twitter.com/" target="_blank">
                ...
                >
                  <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="team-dark" transform="translate(-1018.000000, -2362.000000)" fill="#FFFFFF" fillRule="nonzero">
                      <g id="footer" transform="translate(71.000000, 2361.000000)">
                        <g id="Group-3" transform="translate(688.000000, 0.000000)">
                          <g id="socialmedia">
            ...
            <li>
              <a href="https://www.youtube.com/" target="_blank">
                ...
                >
                  <g id="Page-1" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                    <g id="team-dark" transform="translate(-919.000000, -2361.000000)" fill="#DA1D56" fillRule="nonzero">
                      <g id="footer" transform="translate(71.000000, 2361.000000)">
                        <g id="Group-3" transform="translate(688.000000, 0.000000)">
                          <g id="socialmedia">
