...
FlowRouter.route("/explore/level/:board/:level", {
  name: "Explore",
  action(params) {
    document.title = "ZNotes | Explore";
    mount(App, {
...
FlowRouter.route("/explore/subject/:board/:level/:subject", {
  name: "Explore",
  action(params) {
    document.title = "ZNotes | Explore";
    mount(App, {
...
FlowRouter.route("/explore/module/board/:level/:subject/:module", {
  name: "Explore",
  action() {
    document.title = "ZNotes | Explore";
    mount(App, {
